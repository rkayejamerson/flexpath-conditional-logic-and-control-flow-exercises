...
function exercise_13() {
  ...
  */
  ...
  let var2 = 5;
  ++var2;
  console.log(`Increment: ${var2}`);
  --var2;
  --var2;
  console.log(`Decrement: ${var2}`);
